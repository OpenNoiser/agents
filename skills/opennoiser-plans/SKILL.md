...
1. Call get_pricing at https://opennoiser.com/mcp, fetch https://opennoiser.com/api/agent/pricing, or read https://opennoiser.com/pricing.md. Never hard-code prices from an older conversation.
